var circleNodePointM;

var svg2 = d3.select("#graph2");

function updateCircleGraphM(year){

  //console.log('circle graph is working');

  circleNodePointM = svg2.append("g")
      .attr("width", 825)
      .attr("height", 530)
      .attr("id", 'circleAllIdModal');

  // Read data
  d3.csv("vizFilesM/3circleGraph/Ryan_sports_data.csv", function(data) {
  ...
  var mousemove = function(d) {
    ...
    var node = circleNodePointM.append("g")
      .selectAll("circle")
      .data(data)
      .enter()
      .append("circle")
      ...
      var circle_text = circleNodePointM.selectAll('circle_text')
          .data(data)
          .enter()
          .append('text')
